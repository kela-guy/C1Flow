...
import { PanelLeftIcon } from "@/lib/icons/central";
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      {/*
        The icon depicts the panel on the inline-start side. In RTL
        the panel is physically on the right, so the glyph mirrors.
      */}
