...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      {/*
        Submenu pointer follows the *inline-end* side. Radix's
        DirectionProvider already opens the submenu on the correct
        side for RTL — we only need to mirror the chevron glyph so it
        points the same way the submenu opens.
      */}
  ...
  return (
    <MenuSurface asChild>
      <DropdownMenuPrimitive.SubContent
        ...
        className={cn(
          "text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-md border border-border-default p-1",
          className,
        )}
        {...props}
        align={align}
