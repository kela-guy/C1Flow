...
export const spec: ComponentSpec = {
  ...
  states: [
    ...
    { name: 'zoom-collapsed', trigger: 'No hover/focus on the zoom pill', description: 'Round search-icon trigger only (36px), same footprint as YouTube volume before expand.', implementedInPrototype: true },
    { name: 'zoom-popover-open', trigger: 'pointer or focus on the zoom pill', description: 'Horizontal pill expands: icon + inline range slider (YouTube volume pattern). Closes after 200ms grace on mouseleave/blur.', implementedInPrototype: true },
  ...
  tokens: {
    colors: [
      ...
      { name: 'zoom-pill-bg', value: 'surface-3/90', usage: 'Expanded YouTube-style horizontal pill behind icon + slider' },
      { name: 'zoom-track', value: 'slate-9/80', usage: 'Horizontal range track' },
      { name: 'zoom-thumb', value: 'slate-12', usage: 'Range thumb (white, YouTube volume analogue)' },
    ],
    typography: [
      { name: 'zoom-readout', fontFamily: 'IBM Plex Mono', fontSize: '10px', fontWeight: '500', lineHeight: '1', usage: 'Zoom value in aria-label only (no separate capsule)' },
    ],
    spacing: [
      { name: 'bar-padding', value: '4px 8px 8px', usage: 'Padding inside the bar' },
      { name: 'btn-gap', value: '4px', usage: 'Gap between control buttons' },
      { name: 'zoom-slider-width', value: '96px', usage: 'Expanded horizontal slider width inside the pill' },
    ],
  },
